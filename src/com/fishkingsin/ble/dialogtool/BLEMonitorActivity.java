...
public class BLEMonitorActivity extends Activity {
    ...
    private static final UUID SSMARTWATCH_CHARACTERISTIC = UUID
            .fromString("0000ffe6-0000-1000-8000-00805f9b34fb");
    private static final UUID SSMARTWATCH_INDICATE = UUID
            .fromString("00002a05-0000-1000-8000-00805f9b34fb");
    private static final UUID CLOCK_INDICATE = UUID
            .fromString("0000ffe6-0000-1000-8000-00805f9b34fb");
    ...
    private OnItemClickListener mCharacteristicClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position,
            ...
            if (selectedCharacteristicUUID.equals(PE128_CHAR_XFER) ||
                    selectedCharacteristicUUID.equals(SSMARTWATCH_CHARACTERISTIC)) {
                Intent newIntent = new Intent(
                        BLEMonitorActivity.this,
            ...
            } else if (selectedCharacteristicUUID.equals(BLEService.PWUUIDReceiveData)) {
                mService.EnableDeviceNoti(mDevice, selectedServiceUUID, selectedCharacteristicUUID);
            } else {
                mService.ReadDevice(mDevice,
                        selectedServiceUUID, selectedCharacteristicUUID);
            }
            if (selectedCharacteristicUUID.equals(BLEService.INDICATOR_UUID) ||
                    selectedCharacteristicUUID.equals(BLEService.INDICATOR_UUID49) ||
                    selectedCharacteristicUUID.equals(BLEService.INDICATOR_UUID36) ||
                    selectedCharacteristicUUID.equals(BLEService.INDICATOR_UUID37) ||
                    selectedCharacteristicUUID.equals(BLEService.INDICATOR_UUID38) ||
                    selectedCharacteristicUUID.equals(BLEMonitorActivity.SSMARTWATCH_INDICATE) ||
                    selectedCharacteristicUUID.equals(BLEMonitorActivity.CLOCK_INDICATE)
                    ) {
                mService.EnableDeviceNoti(mDevice, selectedServiceUUID, selectedCharacteristicUUID);
            }
            return;
            ...
            case 0:
                if (resultCode == Activity.RESULT_OK && data != null) {
                    ...
                    if (selectedServiceUUID != null
                        ...
                        mService.WriteDevice(mDevice, selectedServiceUUID,
