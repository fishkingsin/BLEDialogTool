...
public class BLEService extends Service {
    ...
    public static final UUID PWUUIDService = UUID
            .fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
    public static final UUID PWUUIDSendData = UUID
            .fromString("0000ffe4-0000-1000-8000-00805f9b34fb");
    public static final UUID PWUUIDSendAcknowledge = UUID
            .fromString("0000ffe5-0000-1000-8000-00805f9b34fb");
    public static final UUID PWUUIDReceiveData = UUID
            .fromString("0000ffe2-0000-1000-8000-00805f9b34fb");
    public static final UUID PWUUIDReceiveAcknowledge = UUID
            .fromString("0000ffe3-0000-1000-8000-00805f9b34fb");
    public static final UUID PWUUIDCommand = UUID
    ...
    private BluetoothGattCallback mGattCallbacks = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothDevice device, int status) {
            ...
            for (BluetoothGattService service : services) {
                ...
                for (BluetoothGattCharacteristic characteristic : characteristics) {
                    ...
                    EnableDeviceNoti(device, service.getUuid(), characteristic.getUuid());
        ...
        public void onDescriptorRead(BluetoothGattDescriptor descriptor,
            ...
            checkGattStatus(status);
            BluetoothGattCharacteristic mCCC = descriptor
                    .getCharacteristic();
            Log.i(TAG,
                    "Registering for notification UUID : "
                            + mCCC.getUuid());
    ...
    public void ReadDevice(BluetoothDevice iDevice, UUID serviceUUID,
                           UUID charUUID) {
